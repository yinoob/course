  ...
  export default {
    ...
    methods: {
      ...
      list(page) {
        let _this = this;
        //Loading.show();
        axios.post(process.env.VUE_APP_SERVER + '/business/admin/member/list', qs.stringify({
          page: page,
      ...
      save() {
        ...
        //Loading.show();
        axios.post(process.env.VUE_APP_SERVER + '/business/admin/member/save', qs.stringify(_this.member)).then((response)=>{
          //Loading.hide();
          let resp = response.data;
          if (resp.success) {
      ...
      del(id) {
        let _this = this;
        Confirm.show("删除会员表后不可恢复，确认删除？", function () {
          //Loading.show();
          axios.post(process.env.VUE_APP_SERVER + '/business/admin/member/delete',qs.stringify({id: id})).then((response)=>{
            //Loading.hide();
            let resp = response.data;
            if (resp.success) {
              _this.list(1);
