  ...
  export default {
    ...
    methods: {
      ...
      list(page) {
        let _this = this;
        //Loading.show();
        axios.post(process.env.VUE_APP_SERVER + '/system/admin/resource/list', qs.stringify({
          page: page,
      ...
      save() {
        ...
        //Loading.show();
        axios.post(process.env.VUE_APP_SERVER + '/system/admin/resource/save', qs.stringify(_this.resource)).then((response)=>{
          //Loading.hide();
          let resp = response.data;
          if (resp.success) {
      ...
      del(id) {
        ...
        Confirm.show("删除资源后不可恢复，确认删除？", function () {
          //Loading.show();
          axios.post(process.env.VUE_APP_SERVER + '/system/admin/resource/delete',qs.stringify({id: id})).then((response)=>{
            //Loading.hide();
            let resp = response.data;
            if (resp.success) {
              _this.list(1);
