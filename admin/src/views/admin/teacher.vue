            ...
            <form class="form-horizontal" ><!--enctype="multipart/form-data"-->
              ...
              <div class="form-group">
                ...
                <big-file v-bind:id="'image-upload'"
                          v-bind:text="'上传头像'"
                          v-bind:used="FILE_USE.TEACHER.key"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea v-model="teacher.intro" class="form-control" row="5"/>
                </div>
              </div>
            </form>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      list(page) {
        let _this = this;
        //Loading.show();
        axios.post(process.env.VUE_APP_SERVER + '/business/admin/teacher/list', qs.stringify({
          page: page,
      ...
      save() {
        ...
        //Loading.show();
        axios.post(process.env.VUE_APP_SERVER + '/business/admin/teacher/save', qs.stringify(_this.teacher)).then((response)=>{
          //Loading.hide();
          let resp = response.data;
          if (resp.success) {
      ...
      del(id) {
        ...
        Confirm.show("删除讲师后不可恢复，确认删除？", function () {
          //Loading.show();
          axios.post(process.env.VUE_APP_SERVER + '/business/admin/teacher/delete',qs.stringify({id: id})).then((response)=>{
            //Loading.hide();
            let resp = response.data;
            if (resp.success) {
              _this.list(1);
