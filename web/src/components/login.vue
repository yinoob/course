  ...
  export default {
    ...
    methods: {
      ...
      register() {
        ...
        // 调服务端注册接口
          axios.post(process.env.VUE_APP_SERVER + '/business/web/member/register', qs.stringify(_this.memberRegister)).then((response) => {
      ...
      login () {
        ...
        axios.post(process.env.VUE_APP_SERVER + '/business/web/member/login', qs.stringify(_this.member)).then((response)=>{
          let resp = response.data;
          if (resp.success) {
      ...
      sendSmsForRegister() {
        ...
        let sms = {
          ...
          used: SMS_USE.REGISTER.key
        };

        axios.post(process.env.VUE_APP_SERVER + '/business/web/member/is-mobile-exist' ,qs.stringify({mobile:_this.memberRegister.mobile})).then((res)=>{
      ...
      sendSmsCode(sms, btnId) {
        ...
        // 调服务端发短信接口
        axios.post(process.env.VUE_APP_SERVER + '/business/web/sms/send', qs.stringify(sms)).then((res)=> {
          let response = res.data;
          if (response.success) {
            Toast.success("短信已发送");
      ...
      sendSmsForForget() {
        ...
        let sms = {
          ...
          used: SMS_USE.FORGET.key
        };

        axios.post(process.env.VUE_APP_SERVER + '/business/web/member/is-mobile-exist' , qs.stringify({mobile:_this.memberForget.mobile})).then((res)=>{
          let response = res.data;
          if (response.success) {
      ...
      resetPassword() {
        ...
        // 调服务端密码重置接口
        axios.post(process.env.VUE_APP_SERVER + '/business/web/member/reset-password', qs.stringify(_this.memberForget)).then((res)=>{
          let response = res.data;
          if (response.success) {
