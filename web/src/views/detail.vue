  ...
  export default {
    ...
    methods: {
      findCourse() {
        ...
        axios.get(process.env.VUE_APP_SERVER + '/business/web/course/find/' + qs.stringify({id:_this.id})).then((response)=>{
      ...
      enroll() {
        ...
        axios.post(process.env.VUE_APP_SERVER + '/business/web/member-course/enroll', qs.stringify({
      ...
      getEnroll() {
        ...
        axios.post(process.env.VUE_APP_SERVER + '/business/web/member-course/get-enroll', qs.stringify({
          courseId: _this.course.id,
          memberId: loginMember.id
        })).then((response)=>{
          let resp = response.data;
